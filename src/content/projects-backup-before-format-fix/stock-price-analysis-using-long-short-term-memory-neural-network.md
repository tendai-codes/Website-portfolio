...
description: "This project focused on predicting Tesla (TSLA) stock prices using deep learning techniques with LSTM neural networks. I built a time series forecasting model that uses historical closing prices and trading volumes to predict next-day stock prices,…"
...
<figure>
<img alt="Table 1: closing vol Df" class="gallery-trigger" data-caption="Table 1: closing vol Df" data-gallery="LSTM" decoding="async" height="1020" loading="lazy" width="876"/ src="/images/thumbs/LSTM_table%201-900.webp" srcset="/images/thumbs/LSTM_table%201-480.webp 480w, /images/thumbs/LSTM_table%201-900.webp 900w" sizes="(max-width: 640px) calc(100vw - 60px), (min-width: 1181px) 30vw, 46vw" data-full="/images/LSTM_table%201.png">
<figcaption><strong>Table 1</strong></figcaption>
</figure>
<figure>
<img alt="Table 2: LSTM Model Execution" class="gallery-trigger" data-caption="Table 2: LSTM Model Execution" data-gallery="LSTM" decoding="async" height="708" loading="lazy" width="1604"/ src="/images/thumbs/LSTM_table%202-900.webp" srcset="/images/thumbs/LSTM_table%202-480.webp 480w, /images/thumbs/LSTM_table%202-900.webp 900w" sizes="(max-width: 640px) calc(100vw - 60px), (min-width: 1181px) 30vw, 46vw" data-full="/images/LSTM_table%202.png">
<figcaption><strong>Table 2</strong> LSTM Model Execution</figcaption>
</figure>
<figure>
<img alt="Table 3: Closing vs Prediction Price" class="gallery-trigger" data-caption="Table 3: Closing vs Prediction Price" data-gallery="LSTM" decoding="async" height="1042" loading="lazy" width="912"/ src="/images/thumbs/LSTM_table%203-900.webp" srcset="/images/thumbs/LSTM_table%203-480.webp 480w, /images/thumbs/LSTM_table%203-900.webp 900w" sizes="(max-width: 640px) calc(100vw - 60px), (min-width: 1181px) 30vw, 46vw" data-full="/images/LSTM_table%203.png">
<figcaption><strong>Table 3</strong> Closing vs Prediction Price</figcaption>
</figure>
<figure>
<img alt="Figure 1: Closing Price" class="gallery-trigger" data-caption="Figure 1: Closing Price" data-gallery="LSTM" decoding="async" height="964" loading="lazy" width="1396"/ src="/images/thumbs/LSTM_fig%201-900.webp" srcset="/images/thumbs/LSTM_fig%201-480.webp 480w, /images/thumbs/LSTM_fig%201-900.webp 900w" sizes="(max-width: 640px) calc(100vw - 60px), (min-width: 1181px) 30vw, 46vw" data-full="/images/LSTM_fig%201.png">
<figcaption><strong>Figure 1</strong> Closing Price</figcaption>
</figure>
<figure>
<img alt="Figure 2: Closing vs Prediction Price" class="gallery-trigger" data-caption="Figure 2: Closing vs Prediction Price" data-gallery="LSTM" decoding="async" height="964" loading="lazy" width="1396"/ src="/images/thumbs/LSTM_fig%202-900.webp" srcset="/images/thumbs/LSTM_fig%202-480.webp 480w, /images/thumbs/LSTM_fig%202-900.webp 900w" sizes="(max-width: 640px) calc(100vw - 60px), (min-width: 1181px) 30vw, 46vw" data-full="/images/LSTM_fig%202.png">
