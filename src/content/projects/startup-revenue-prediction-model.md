...
description: "This project built a multiple linear regression model to predict startup profitability based on their R&D spending, administration costs, marketing expenditure, and location. I implemented a complete machine learning pipeline using scikit-learn to analyze…"
...
<figure>
<img alt="Figure 1: startup" class="gallery-trigger" data-caption="Figure 1: startup" data-gallery="startup" decoding="async" height="380" loading="lazy" width="1372" src="/images/thumbs/startup_table1-900.webp" srcset="/images/thumbs/startup_table1-480.webp 480w, /images/thumbs/startup_table1-900.webp 900w" sizes="(max-width: 640px) calc(100vw - 60px), (min-width: 1181px) 30vw, 46vw" data-full="/images/startup_table1.png">
